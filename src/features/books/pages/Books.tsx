...
const Books: React.FC = () => {
    ...
    return (
        <Layout>
            {/* Delete Mode Scrim Overlay — starts below the fixed Header (top-16)
                so the real header bar stays fully visible/opaque, not dimmed by it */}
            {isDeleteMode && (
                <div 
            ...
            <div className={`relative ${isDeleteMode ? 'z-45' : ''}`}>
                <div ref={stickyBarRef} className="sticky top-16 z-30 -mx-6 px-6 -mt-6 py-4 bg-gray-900 border-b border-gray-800">
                    <div className="flex items-center gap-4">
                        ...
                        {/* Action Buttons — admin only, matches backend's authorize('admin') on writes.
                            Spacer keeps the search bar centered for non-admins, who see no buttons here. */}
                        {isAdmin ? (
                            <div className="flex gap-2 shrink-0">
                                <button
                                    ...
                                    className={`flex items-center justify-center gap-1 px-4 py-2 rounded-lg transition-colors
                                        outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 ${
                                        isDeleteMode 
                                ...
                                <button
                                    onClick={handleDeleteModeToggle}
                                    className={`flex items-center justify-center gap-1 px-4 py-2 rounded-lg transition-colors
                                        outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 ${
                                        isDeleteMode 
                                            ? 'bg-gray-600 hover:bg-gray-700 text-white focus-visible:ring-gray-400' 
                ...
                {isDeleteMode && (
                    <div
                        className="sticky z-30 -mx-6 px-6 py-3 bg-gray-800 border-b border-gray-700 flex items-center justify-between"
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-blue-400 hover:text-blue-300 text-sm rounded outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800"
                            >
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-lg transition-colors outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800"
                        >
                            Delete Selected
                        </button>
                    </div>
                ...
                {/* Sort/filter */}
                <div className="flex items-center mb-4 mt-6 gap-4 flex-wrap">
